function [J grad] = nnCostFunction(nn_params, ...
                                   ...
                                   num_labels, ...
                                   X, y, lambda)
%NNCOSTFUNCTION Implements the neural network cost function for a 3 layer
%neural network which performs classification
%   [J grad] = NNCOSTFUNCTON(nn_params, hidden_layer1_size, hidden_layer2_size, num_labels, ...
...
J2 = lambda / (2 * m) * (sum(sumsq(Theta1(:, 2:end))) + sum(sumsq(Theta2(:, 2:end))) + sum(sumsq(Theta3(:, 2:end))));
...
Theta3_l = Theta3_l(:, 2:end);
Theta3_l = [zeros(size(Theta3_l, 1), 1), Theta3_l];


Theta1_grad = Theta1_grad + Theta1_l;
Theta2_grad = Theta2_grad + Theta2_l;
Theta3_grad = Theta3_grad + Theta3_l;
